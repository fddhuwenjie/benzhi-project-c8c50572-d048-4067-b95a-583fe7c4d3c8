...
func (s *Service) Create(input CreateInput, requestID string) (*domain.Campaign, error) {
	return s.createWithPlan(context.Background(), input, nil, requestID, false)
}
...
func (s *Service) CreateWithPlan(input CreateInput, measurementPlan *domain.MeasurementPlan, requestID string) (*domain.Campaign, error) {
	return s.createWithPlan(context.Background(), input, measurementPlan, requestID, true)
}

func (s *Service) CreateWithPlanContext(ctx context.Context, input CreateInput, measurementPlan *domain.MeasurementPlan, requestID string) (*domain.Campaign, error) {
	return s.createWithPlan(ctx, input, measurementPlan, requestID, true)
}
...
func (s *Service) createWithPlan(ctx context.Context, input CreateInput, measurementPlan *domain.MeasurementPlan, requestID string, useDefault bool) (*domain.Campaign, error) {
	...
	conflicts, err := s.Store.CreateCampaignAtomicContext(ctx, c, event, key, hash)
