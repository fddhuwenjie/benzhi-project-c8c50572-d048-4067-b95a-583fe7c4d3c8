...
func (s *Service) ArchiveWithToken(id string, revision int64, token string) (*domain.Artifact, error) {
	return s.ArchiveWithTokenContext(context.Background(), id, revision, token)
}

func (s *Service) ArchiveWithTokenContext(ctx context.Context, id string, revision int64, token string) (*domain.Artifact, error) {
	...
	return s.ArchiveContext(ctx, id, revision)
}
